...
export class AuthEffects{
  ...
  authLogin = this.actions$.pipe(
    ofType(AuthActions.LOGIN_START),            //only for this action other actins are not accepted
                                                 //return new observalble
  ...
  @Effect({dispatch:false})                  //does not returns a action
